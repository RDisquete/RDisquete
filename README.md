...
- **Tech:** JavaScript (ES6+), Web Audio API, Canvas.
- 🔗 [Ver Demo en Vivo](https://mattersoundrdisquete.netlify.app/)

### 🚴‍♂️ [Nor3xtrem 2026](https://github.com/RDisquete/Nor3Xtreme-2026)
*Web oficial para evento deportivo masivo (+3000 inscritos).*
- **El Reto:** Gestión de assets técnicos complejos y optimización de **Core Web Vitals** para alto tráfico.
- **Tech:** Web Performance, Responsive Design, UI/UX.
- 🔗 [Visitar Web Oficial](https://nor3xtrem.es/)

### 👗 [Armario Escénico](https://github.com/RDisquete/ArmarioEscenico)
*Aplicación interactiva con gestión de estados.*
- **El Reto:** Implementación de lógica de usuario y manejo de interacciones dinámicas en React.
...
## 🔗 Conectemos
- 🌍 **Web Personal:** [rdisquete.es](https://rdisquete.es)
- 📸 **Instagram:** [@rdisquete](https://instagram.com/rdisquete)
- 💼 **LinkedIn:** [https://www.linkedin.com/in/rafael-dorado-zamoro-a0008610a/]

*"El código es el motor, pero la interfaz es el alma."*
